...
const testimonials = [
  ...
  {
    Icon: "/images/azm-logo.png",
    description:
    "شركة عزم، شركة سعودية رائدة في التكنولوجيا والتحول الرقمي، تدعم المؤسسات في تحقيق التحول بكفاءة عالية. تقدم خدمات مثل الاستشارات التقنية، تطوير البرمجيات، الأمن السيبراني، والحلول السحابية، مع التركيز على الذكاء الاصطناعي وتحليل البيانات لتحسين الأداء المؤسسي. تساهم عزم في تحقيق رؤية السعودية 2030 من خلال تعزيز الابتكار ودعم الاقتصاد الرقمي، مما يجعلها شريكًا استراتيجيًا للقطاعات الحكومية والخاصة.",
    name: "عزم السعودية",
  },
  {
    Icon: "/images/gamifier-logo.png",
    description:
    "جيمفاير هي شركة رائدة في مجال تحويل التجارب التقليدية إلى تجارب مبتكرة عن طريق التلعيب. تعمل الشركة على استخدام استراتيجيات مبتكرة وتقنيات حديثة لإنشاء حلول مثيرة تدمج اساليب التلعيب في مختلف جوانب الحياة. سواء كان الهدف تحفيز السلوك، أو تعزيز التعلم، تقدم لك جيمفاير عناصر من الألعاب لإنشاء تجارب ممتعة وذات تأثير تفاعلي سواء للأفراد أو للشركات.",
    name: "قيميفاير",
  },
];

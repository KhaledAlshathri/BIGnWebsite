...
const smallCards = [
  ...
  { id: 14, imgUrl: "/images/boy-icon.png", title: "بدر الزهراني", description: "قائد فريق شؤون المستفيدين", linkedinUrl: "https://www.linkedin.com/in/badermalzahrani/" },
  { id: 15, imgUrl: "/images/girl-icon.png", title: "هتاف السويلم", description: "نائبة فريق شؤون المستفيدين", linkedinUrl: "https://www.linkedin.com" },
  { id: 16, imgUrl: "/images/girl-icon.png", title: "إيلاف الشهري", description: "قائد فريق شؤون الأعضاء", linkedinUrl: "http://www.linkedin.com/in/ElafAlshehri" },
  { id: 17, imgUrl: "/images/girl-icon.png", title: "رغد الهزاني", description: "نائب فريق شؤون الأعضاء", linkedinUrl: "https://www.linkedin.com/in/raghad-alhazzani-391406281?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" },
  ...
  { id: 20, imgUrl: "/images/boy-icon.png", title: "محمد الصعب", description: "نائب لجنة العلاقات العامة", linkedinUrl: "https://www.linkedin.com" },
  { id: 21, imgUrl: "/images/girl-icon.png", title: "منه سليمان", description: "نائب لجنة العلاقات العامة", linkedinUrl: "https://www.linkedin.com" },
